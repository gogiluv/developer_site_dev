...
( function () {
	...
	Object.assign( THREE.FBXLoader.prototype, {
		...
		load: function ( url, onLoad, onProgress, onError ) {
			...
			loader.load( url, function ( buffer ) {
				...
				console.log('url : '+ url + ' / buffer : ' + buffer + ' / resourceDirectory : ' + resourceDirectory);
				try {
		...
		parse: function ( FBXBuffer, resourceDirectory ) {
			...
			console.log('parse] FBXBuffer : ' + FBXBuffer + ' / resourceDirectory : ' + resourceDirectory);
	...
	function parseConnections( FBXTree ) {
		...
		//console.log('parseConnections] FBXTree : ' + FBXTree);
	...
	function parseImages( FBXTree ) {
		...
		//console.log('parseImages] FBXTree : ' + FBXTree);
	...
	function parseImage( videoNode ) {
		...
		//console.log('parseImage] videoNode : ' + videoNode);
	...
	function parseTextures( FBXTree, loader, images, connections ) {
		...
		//console.log('parseTextures] FBXTree : ' + FBXTree);
	...
	function parseTexture( textureNode, loader, images, connections ) {
		...
		//console.log('parseTexture] textureNode : ' + textureNode);
	...
	function loadTexture( textureNode, loader, images, connections ) {
		...
		//console.log('loadTexture] textureNode : ' + textureNode);
	...
	function parseMaterials( FBXTree, textureMap, connections ) {
		...
		//console.log('parseMaterials] FBXTree : ' + FBXTree);
	...
	function parseMaterial( FBXTree, materialNode, textureMap, connections ) {
		...
		//console.log('parseMaterial] FBXTree : ' + FBXTree);
	...
	function parseParameters( FBXTree, properties, textureMap, ID, connections ) {
		...
		//console.log('parseParameters] FBXTree : ' + FBXTree);
	...
	function getTexture( FBXTree, textureMap, id, connections ) {
		...
		//console.log('getTexture] FBXTree : ' + FBXTree);
	...
	function parseDeformers( FBXTree, connections ) {
		...
		//console.log('parseDeformers] FBXTree : ' + FBXTree);
	...
	function parseSkeleton( connections, deformerNodes ) {
		...
		//console.log('parseSkeleton] connections : ' + connections);
	...
	function parseGeometries( FBXTree, connections, skeletons ) {
		...
		//console.log('parseGeometries] FBXTree : ' + FBXTree);
	...
	function parseGeometry( FBXTree, relationships, geometryNode, skeletons ) {
		...
		//console.log('parseGeometry] FBXTree : ' + FBXTree);
	...
	function parseMeshGeometry( FBXTree, relationships, geometryNode, skeletons ) {
		...
		console.log('parseMeshGeometry] FBXTree : ' + geometryNode);
	...
	function genGeometry( FBXTree, relationships, geometryNode, skeleton, preTransform ) {
		...
		//console.log('genGeometry] FBXTree : ' + FBXTree);
	...
	function getNormals( NormalNode ) {
		...
		//console.log('getNormals] NormalNode : ' + NormalNode);
	...
	function getUVs( UVNode ) {
		...
		//console.log('getUVs] UVNode : ' + UVNode);
	...
	function getMaterials( MaterialNode ) {
		...
		//console.log('getMaterials] MaterialNode : ' + MaterialNode);
